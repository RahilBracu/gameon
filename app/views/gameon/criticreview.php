...
<body>
    ...
    <main class="main-game">
        ...
        <section class="game-tabs">
            ...
            <a class="active-tab" href="<?=ROOT?>game/<?=$data['game_info'][0]->game_name?>/critic-reviews"><button>Critic Reviews</button></a>
        ...
        <?php if(!(isset($_SESSION['user_id']) && $_SESSION['user_id'] == 0)):?>
            <section class="submit-review">
                <h4>Are you a critic?</h4>
                <p>If you're running a website/blog, you're in the right place. You can share your valuable comments, post the article you've written on this game. Share your thoughts on the game and become an honorable member of our website. Make sure to submit your review now!</p>
                <a href="<?=ROOT?>criticsubmission/<?=$data['game_info'][0]->game_name?>">
                    <div class="btn">review</div>
                </a>
            </section>
        <?php endif;?>
        <section class="critic-comments">
            <?php if(!is_array($data['critic_comments'])) :?>
                <div class="error-container"><p><?php check_message()?></p></div>
            <?php endif;?>
            <div class="comments">
                <?php if(is_array($data['critic_comments'])) :?>
                    <?php foreach($data['critic_comments'] as $row) :?>
                        <div class="comment">
                            <div class="top">
                                <div class="user-info">
                                    <img src="<?=ASSETS?>gameon/img/default_group.png" alt="Profile Picture">
                                    <p><?=$row->critic?></p>
                                </div>
                                <div class="score">
                                    <p><?=$row->score?></p>
                            ...
                            <a href="<?=$row->link?>">Read Full Review</a>
                        </div>
                    <?php endforeach;?>
                <?php endif;?>
            </div>
