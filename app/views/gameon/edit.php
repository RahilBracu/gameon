...
<body>
    ...
    <main>
        ...
        <div class="account-bg bg-pos"></div>
            <div class="manage-acc">
                <a href="<?=ROOT?>account/<?=$_SESSION['username']?>/account-info"><button>View my profile</button></a>
                <a class="active-tab" href="<?=ROOT?>account/<?=$_SESSION['username']?>/edit-account"><button>Edit my profile</button></a>
                <a href="<?=ROOT?>account/<?=$_SESSION['username']?>/change-password"><button>Change password</button></a>
                <a href="<?=ROOT?>account/<?=$_SESSION['username']?>/delete-account"><button>Delete account</button></a>
            </div>
            <div class="form">
                <div class="container">
                    <p>edit your profile</p>
                    <form class="info" method="POST">
                        <input type="text" name="fname" class="input" value="<?=$_SESSION['fname']?>" placeholder="Full Name*">
                        <input type="text" name="dob" class="input" value="<?=$_SESSION['dob']?>" placeholder="Date of Birth*" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}">
                        <input type="email" name="email" class="input" value="<?=$_SESSION['email']?>" placeholder="Email*">
