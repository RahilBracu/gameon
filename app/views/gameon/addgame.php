        ...
        <section class="form add-game-form">
            <div class="container request-container">
                ...
                <form class="info" autocomplete="off" method="POST">
                    <input type="text" name="game_name" class="input" placeholder="Game ID*" required>
                    <input type="text" name="name" class="input" placeholder="Game Name*" required>
                    <input type="text" name="thumbnail" class="input" placeholder="Thumbnail Image Location*" required>
                    ...
                    <input type="text" name="cover" class="input" placeholder="Cover Image Location*" required>
                    <textarea name="about" id="ta" placeholder="About Game*" required></textarea>
                    <input type="text" name="platform" class="input" placeholder="Available Platforms*" required>
                    <input type="text" name="genre" class="input" placeholder="Genre*" required>
                    <input type="text" name="release_date" class="input" placeholder="Release Date*" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" required>
                    ...
                    <input type="submit" class="form-btn" value="add game">
                </form>
