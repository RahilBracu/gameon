...
<body>
    ...
    <main>
        <section class="form">
            <div class="submission-bg bg-pos"></div>
            <div class="container">
                <p><?=$data['game_info'][0]->name?> |</p>
                <p>Critic Review</p>
                <form class="info" autocomplete="off" method="POST">
                    <input type="hidden" name="game_name" class="input" value="<?=$data['game_name']?>">
                    <input type="text" name="critic" class="input" placeholder="Organization*" required>
                    <input type="email" name="email" class="input" placeholder="Email*" required>
                    <input type="number" name="score" class="input" min="0" max="50" placeholder="Game Score (0 - 50)*" required>
                    <input type="url" name="link" class="input" placeholder="Article Link*" required>
                    <textarea name="comment" id="ta" placeholder="Comments on the Game*" required></textarea>
