    ...
    <main>
        ...
        <div class="account-bg bg-pos"></div>
            <div class="manage-acc">
                ...
                <a href="<?=ROOT?>account/<?=$_SESSION['username']?>/edit-account"><button>Edit my profile</button></a>
                <a class="active-tab" href="<?=ROOT?>account/<?=$_SESSION['username']?>/change-password"><button>Change password</button></a>
            ...
            <div class="form">
                <div class="container">
                    ...
                    <form class="info" method="POST">
                        <input type="password" name="old_password" class="input" placeholder="Old password*">
                        ...
                        <input type="submit" class="form-btn" value="Change">
                    </form>
