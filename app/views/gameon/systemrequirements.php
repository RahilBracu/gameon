...
<body>
    ...
    <main class="main-game">
        ...
        <section class="game-tabs">
            ...
            <a class="active-tab" href="<?=ROOT?>game/<?=$data['game_info'][0]->game_name?>/system-requirements"><button>System Requirements</button></a>
        </section>
        <section class="sysreq">
            <?php if(!is_array($data['system_req'])) :?>
            ...
            <?php if(is_array($data['system_req'])) :?>
                ...
                <div class="sr-min">
                    <h4>Minimum</h4>
                    <p><?=$data['system_req'][0]->p1_m?><br><?=$data['system_req'][0]->p2_m?></p><br>
                    <p><?=$data['system_req'][0]->g1_m?><br><?=$data['system_req'][0]->g2_m?></p><br>
                    <p><?=$data['system_req'][0]->vr_m?></p><br>
                    <p><?=$data['system_req'][0]->v_m?></p><br>
                    <p><?=$data['system_req'][0]->os_m?></p><br>
                    <p><?=$data['system_req'][0]->dx_m?></p><br>
                    <p><?=$data['system_req'][0]->hdd_m?></p><br>
                </div>
                <div class="sr-rm">
                    <h4>Recommended</h4>
                    <p><?=$data['system_req'][0]->p1_r?><br><?=$data['system_req'][0]->p2_r?></p><br>
                    <p><?=$data['system_req'][0]->g1_r?><br><?=$data['system_req'][0]->g2_r?></p><br>
                    <p><?=$data['system_req'][0]->vr_r?></p><br>
                    <p><?=$data['system_req'][0]->v_r?></p><br>
                    <p><?=$data['system_req'][0]->os_r?></p><br>
                    <p><?=$data['system_req'][0]->dx_r?></p><br>
                    <p><?=$data['system_req'][0]->hdd_r?></p><br>
                </div>
            <?php endif;?>
        </section>
    </main>
